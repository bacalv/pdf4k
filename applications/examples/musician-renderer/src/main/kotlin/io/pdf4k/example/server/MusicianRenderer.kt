...
object MusicianRenderer {
    operator fun invoke(): (MusicianList) -> Pdf = { list ->
        content {
                    ...
                    list.musicians.forEachIndexed { index, artist ->
                        style(if (index % 2 == 0) evenRow else oddRow) {
                            imageCell(
                                ...
                                style = StyleAttributes.style(align = Center, valign = Middle),
                                width = 200f,
                                height = 200f
                            )
                            tableCell(1, noBorder) {
                                ...
                                tableCell(columns = 1, margin = Margin(0f, 0f, 24f, 24f)) {
                                    tableCell(2, bioTable, weights = listOf(1f, 3f)) {
                                        textCell("DOB", bioHeader + StyleAttributes.style(borderColourBottom = WHITE))
